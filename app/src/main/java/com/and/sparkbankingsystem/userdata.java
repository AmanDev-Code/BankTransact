...
public class userdata extends AppCompatActivity {
    ...
    String phonenumber;
    Double newbalance;
    TextView username, phoneNumber, email, account_no, ifsc_code,balance;
    ...
    private void enterAmount() {
        ...
        dialog.show();
        dialog.getWindow().setBackgroundDrawableResource(R.color.enterAmount);
    ...
    private void transactionCancel() {
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new DatabaseHelper(userdata.this).insertTransferData(date, username.getText().toString(), "Not selected", "0", "Failed");
        ...
        alertexit.show();
        alertexit.getWindow().setBackgroundDrawableResource(android.R.color.holo_blue_light);
    }
